...
const datenschutz = () => {
  return (
    ...
    <div className='inline-block'>
        ...
        <div className='p-4'>
            <h2 className='text-3xl py-2'>Datenschutzerklärung</h2>
            <p className='text-2xl py-2'>Verantwortlicher für die Datenverarbeitung ist:</p>
        </div>
        <div className='p-4'>
            <p className='text-xl'>
            Hüseyin Kapici
        ...
        <h2 className='text-2xl'>1. Zugriffsdaten und Hosting</h2> <br />
...
<br />
<h2 className='text-2xl py-3'>1.1 Hosting</h2>
...
<br />
<h2 className='text-2xl py-3'>1.2 Content Delivery Network</h2>
...
<br />
<h2 className='text-2xl py-3'>2. Datenverarbeitung zur Kontaktaufnahme und Kundenkommunikation</h2>
 <h2 className='text-2xl py-3'>Kontaktaufnahme</h2>
...
<br />
<h2 className='text-2xl py-3'>3. Cookies und weitere Technologien</h2>
<h2 className='text-2xl py-3'>3.1 Allgemeine Informationen</h2>
...
<br />
Die Cookie-Einstellungen für Ihren Browser finden Sie unter den folgenden Links: Microsoft Edge™ / Safari™ / Chrome™ / Firefox™ / Opera™ Alternativ können Sie auch folgenden Link aufrufen: https://www.bk-bauputz-hh.de/datenschutz/. Bei der Nichtannahme von Cookies kann die Funktionalität unserer Webseite eingeschränkt sein.
<br />
<h2 className='text-2xl py-3'>3.2 Einsatz des Jimdo Consent Manager Tool zur Verwaltung von Einwilligungen</h2>
...
<br />
<h2 className='text-2xl py-3'>4. Einsatz von Cookies und anderen Technologien zu Webanalyse und Werbezwecken</h2>
...
<br />
 <h2 className='text-2xl py-3'>Google Maps</h2>
...
<br />
<h2 className='text-2xl py-3'>5. Social Media</h2>
...
<br />
<h2 className='text-2xl py-3'>6. Kontaktmöglichkeiten und Ihre Rechte</h2>
<h2 className='text-2xl py-3'>6.1 Ihre Rechte</h2>
...
<div className='p-3 border-solid border-2 border-black'>
<h2 className='text-2xl pb-3'>Widerspruchsrecht</h2>
...
<br />
<h2 className='text-2xl py-3'>6.2 Kontaktmöglichkeiten</h2>
